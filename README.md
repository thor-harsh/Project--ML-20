...
**In this project we have applied PCA (Principal Component Analysis) on Wine Quality Dataset to get the best 3 principal components and thus reducing it from higher dimensions to lower dimensions and plotting a 3d plot of that.**
